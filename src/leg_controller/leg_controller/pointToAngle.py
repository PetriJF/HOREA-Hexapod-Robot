...
def getLegAngles(point = Point, leg = legReferencing):
    # Constants
    COXA_LEN = 71.5
    FEMUR_LEN = 100.02
    FOOT_HEIGHT = 0
    ...
    ### TODO: Add the alpha angle computation
    ...
    tetha1 = beta - delta
    tetha2 = 180.0 - sigma - 45.0 # Note that the 45 represents the assembly offset between the tibia and femur!
