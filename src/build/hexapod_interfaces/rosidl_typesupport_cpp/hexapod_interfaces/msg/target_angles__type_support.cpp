...
static const _TargetAngles_type_support_symbol_names_t _TargetAngles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hexapod_interfaces, msg, TargetAngles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hexapod_interfaces, msg, TargetAngles)),
  }
};
...
{
  return &::hexapod_interfaces::msg::rosidl_typesupport_cpp::TargetAngles_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hexapod_interfaces, msg, TargetAngles)() {
  return get_message_type_support_handle<hexapod_interfaces::msg::TargetAngles>();
}
