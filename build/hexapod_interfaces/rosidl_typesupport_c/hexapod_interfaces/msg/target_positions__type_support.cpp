...
static const _TargetPositions_type_support_symbol_names_t _TargetPositions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hexapod_interfaces, msg, TargetPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hexapod_interfaces, msg, TargetPositions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hexapod_interfaces, msg, TargetPositions)() {
  return &::hexapod_interfaces::msg::rosidl_typesupport_c::TargetPositions_message_type_support_handle;
}
